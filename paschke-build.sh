...
qemu-system-i386 -drive file=win95_disk.img,format=raw -m 100 -boot order=ca,once=a -vga std -drive file=images/622C.IMG,format=raw,index=0,if=floppy -nic none
